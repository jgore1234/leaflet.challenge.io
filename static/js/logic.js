let allweekquake = "https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_week.geojson";
let platetechURL = "https://raw.githubusercontent.com/fraxen/tectonicplates/master/GeoJSON/PB2002_boundaries.json";
...
d3.json(allweekquake).then(function(data) {
...
d3.json(platetechURL).then(function(plateData) {
